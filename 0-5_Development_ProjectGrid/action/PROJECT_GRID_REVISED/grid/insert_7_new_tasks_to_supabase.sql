...
INSERT INTO project_grid_tasks_revised (
  ...
  dependency_chain, progress, status, priority, estimated_hours, actual_hours,
  generated_files, test_history, build_result, dependencies, blocking_tasks, notes,
  ...
  6.0,
  ARRAY[
    '1_Frontend/src/app/api/politicians/route.ts (수정)',
    ...
    '1_Frontend/src/types/politician.ts (신규)'
  ],
  '최종: Build ✅ + Type ✅',
  '2차: Build ✅',
  ARRAY['P2D1'],
...
INSERT INTO project_grid_tasks_revised (
  ...
  3.5,
  ARRAY[
    '1_Frontend/src/utils/fieldMapper.ts (신규)',
    '1_Frontend/src/types/politician.ts (신규)',
    '1_Frontend/src/app/api/politicians/[id]/route.ts (수정)',
    '1_Frontend/src/app/api/politicians/route.ts (수정)',
    'add_politician_official_info_fields.sql (신규)'
  ],
...
INSERT INTO project_grid_tasks_revised (
  ...
  ARRAY[
    '1_Frontend/src/app/api/politicians/[id]/route.ts (수정)',
    '1_Frontend/src/lib/database.types.ts (수정)'
  ],
  '최종: Build ✅ + API Test ✅',
  '2차: Build ✅',
  ARRAY['P3BA2'],
  ARRAY[]::text[],
  '점수-등급 불일치 해결. DB의 grade_code 대신 API에서 점수 기반 등급 재계산. Git: 17f58d5',
  NOW(),
  NOW()
);
...
INSERT INTO project_grid_tasks_revised (
  ...
  ARRAY[
    '1_Frontend/src/app/api/politicians/route.ts (수정)',
    '1_Frontend/src/utils/fieldMapper.ts (수정)'
  ],
  '최종: Build ✅ + API Test ✅',
  '2차: Build ✅',
  ARRAY['P3BA33'],
  ARRAY[]::text[],
  '목록 API에서 ai_final_scores 테이블 조회 추가. calculateV24Grade() 함수 구현. Git: d0b8fb9',
  NOW(),
  NOW()
);
...
INSERT INTO project_grid_tasks_revised (
  ...
  ARRAY['P3BA33', 'P3BA34'],
  ARRAY[]::text[],
  'AI_SCORES, CATEGORY_SCORES 하드코딩 제거. Claude AI만 사용. 실제 API 데이터 표시. Git: e3b45ca',
  NOW(),
  NOW()
);
...
INSERT INTO project_grid_tasks_revised (
  ...
  3.5,
  ARRAY[
    '0-4_Database/Supabase/migrations/060_follow_system_complete.sql (신규)',
    '1_Frontend/src/app/api/users/[id]/follow/route.ts (신규)',
    '1_Frontend/src/app/api/users/[id]/followers/route.ts (신규)',
    '1_Frontend/src/app/api/users/[id]/following/route.ts (신규)',
    '1_Frontend/src/app/api/users/[id]/stats/route.ts (신규)'
  ],
...
INSERT INTO project_grid_tasks_revised (
  ...
  3.0,
  ARRAY[
    '1_Frontend/src/components/FollowButton.tsx (신규)',
    '1_Frontend/src/components/GradeUpgradeModal.tsx (신규)',
    '1_Frontend/src/app/users/[id]/followers/page.tsx (신규)',
    '1_Frontend/src/app/users/[id]/following/page.tsx (신규)',
