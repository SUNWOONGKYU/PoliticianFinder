...
AI 평가 스키마 작업을 완료하여 프로젝트의 Database 영역 개발을 진행합니다.
...
`supabase/migrations/005_evaluations_schema.sql`


**구현해야 할 세부 항목**:

1. ai_evaluations 테이블 (평가 엔진 연동용)
2. evaluation_cache 테이블
3. 인덱스
4. RLS 정책
