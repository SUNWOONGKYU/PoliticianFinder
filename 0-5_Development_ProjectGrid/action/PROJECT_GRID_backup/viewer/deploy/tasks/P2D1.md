...
정치인 스키마 작업을 완료하여 프로젝트의 Database 영역 개발을 진행합니다.
...
`supabase/migrations/003_politicians_schema.sql`


**구현해야 할 세부 항목**:

1. politicians 테이블
2. politician_details 테이블
3. political_parties 테이블
4. constituencies 테이블
5. positions 테이블
6. promises 테이블
7. voting_records 테이블
8. activity_logs 테이블
9. 인덱스 생성
10. Full-text search 인덱스
11. RLS 정책
