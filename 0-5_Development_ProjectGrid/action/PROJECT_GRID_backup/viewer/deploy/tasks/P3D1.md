...
게시글 스키마 작업을 완료하여 프로젝트의 Database 영역 개발을 진행합니다.
...
`supabase/migrations/007_posts_schema.sql`


**구현해야 할 세부 항목**:

1. posts 테이블
2. board_types 테이블 (2개: 정치인/회원)
3. post_politician_tags 테이블
4. post_attachments 테이블
5. post_views 테이블
6. 인덱스
7. Full-text search
8. RLS 정책
