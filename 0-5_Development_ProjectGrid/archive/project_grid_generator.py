#!/usr/bin/env python3
"""
PROJECT GRID 자동 생성 도구
매뉴얼 V2.0 기준 21개 속성 자동 채우기
"""
...
class ProjectGridGenerator:
    """프로젝트 계획서에서 PROJECT GRID SQL 자동 생성"""
...
def main():
    ...
    # 파일 저장
    output_path = "G:/내 드라이브/Developement/PoliticianFinder/PROJECTGRID_Viewer/generated_grid.sql"
    with open(output_path, 'w', encoding='utf-8') as f:
        f.write(sql)

    print(f"[OK] PROJECT GRID 생성 완료!")
    print(f"[INFO] 작업 수: {len(tasks)}개")
    print(f"[FILE] SQL: {output_path}")
    print(f"\n--- 생성된 작업 목록 ---")
    ...
    csv_path = "G:/내 드라이브/Developement/PoliticianFinder/PROJECTGRID_Viewer/generated_grid.csv"
