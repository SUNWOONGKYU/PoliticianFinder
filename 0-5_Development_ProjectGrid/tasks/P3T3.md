...
댓글 API 테스트 작업을 완료하여 프로젝트의 Test 영역 개발을 진행합니다.
...
`tests/api/comments.test.ts` (← 54-55)
...
- 댓글 API 테스트 기능을 구현합니다
- 생성 파일: `tests/api/comments.test.ts` (← 54-55)
- 프로젝트 코딩 컨벤션 준수
- 필요한 경우 추가 파일 생성
