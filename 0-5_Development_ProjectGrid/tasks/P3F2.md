...
게시글 작성 페이지 (회원) 작업을 완료하여 프로젝트의 Frontend 영역 개발을 진행합니다.
...
**기준 파일**: `0-2_UIUX_Design/prototypes/html/pages/write-post_member.html`
...
1. HTML 프로토타입 write-post_member.html을 Next.js로 변환
2. 제목, 본문 입력
3. 이미지 업로드
4. 카테고리 선택
5. 임시저장 기능
