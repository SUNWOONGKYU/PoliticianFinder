...
정치인 목록 페이지 작업을 완료하여 프로젝트의 Frontend 영역 개발을 진행합니다.
...
**기준 파일**: `0-2_UIUX_Design/prototypes/html/pages/politicians.html`
...
1. HTML 프로토타입 politicians.html을 Next.js로 변환
2. 검색/필터: 10개 정당, 17개 지역, 6개 직책
3. 정렬: AI평점순, 회원평점순, 이름순
4. 정치인 카드 그리드: 프로필 이미지, AI평점, 회원평점, 등급, 즐겨찾기
5. 무한 스크롤 또는 페이지네이션
6. 프로토타입의 필터 UI, 카드 디자인 동일하게 적용
