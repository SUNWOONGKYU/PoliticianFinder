...
커뮤니티 메인 페이지 작업을 완료하여 프로젝트의 Frontend 영역 개발을 진행합니다.
...
**기준 파일**: `0-2_UIUX_Design/prototypes/html/pages/community.html`
...
1. HTML 프로토타입 community.html을 Next.js로 변환
2. 2개 게시판 탭: 정치인 게시판, 회원 게시판
3. 검색 바
4. 게시글 리스트: 제목, 작성자, 댓글 수, 좋아요
5. 프로토타입의 탭 UI, 게시글 카드 디자인 동일하게 적용
