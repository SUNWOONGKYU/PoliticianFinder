...
게시글 작성 페이지 (정치인) 작업을 완료하여 프로젝트의 Frontend 영역 개발을 진행합니다.
...
**기준 파일**: `0-2_UIUX_Design/prototypes/html/pages/write-post_politician.html`
...
1. HTML 프로토타입 write-post_politician.html을 Next.js로 변환
2. 정치인 전용 글쓰기 UI
3. 공약/활동 보고 템플릿
4. 인증 배지 표시
