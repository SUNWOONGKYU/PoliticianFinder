...
**기준 파일**: `0-2_UIUX_Design/prototypes/html/pages/base-template.html (헤더/푸터)`
...
1. HTML 프로토타입의 헤더 구조 그대로 변환
2. PoliticianFinder 로고, 캐치프레이즈
3. 네비게이션: 홈, 정치인, 커뮤니티, 연결
4. 알림 아이콘 (빨간색 뱃지)
5. 로그인/회원가입 버튼
6. 모바일 햄버거 메뉴
7. 푸터: 주황색 배경 (#f97316)
8. 서비스 소개, 이용약관, 개인정보처리방침, 고객센터 링크
