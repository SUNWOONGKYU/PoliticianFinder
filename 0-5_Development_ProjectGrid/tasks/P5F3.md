...
서비스 중계 페이지 작업을 완료하여 프로젝트의 Frontend 영역 개발을 진행합니다.
...
**기준 파일**: `0-2_UIUX_Design/prototypes/html/pages/service-relay.html`
...
1. HTML 프로토타입 service-relay.html을 Next.js로 변환
2. 외부 서비스 연결
3. OAuth 인증
