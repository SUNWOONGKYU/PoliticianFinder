...
**기준 파일**: `0-2_UIUX_Design/prototypes/html/pages/politician-detail.html`
...
1. HTML 프로토타입 politician-detail.html을 Next.js로 변환
2. 기본 정보: 사진, 이름, 정당, 지역, 직책
3. AI 평가 점수 및 상세 분석
4. 회원 평가 및 리뷰
5. 경력/공약/법안 탭
6. 즐겨찾기 버튼
7. 프로토타입의 레이아웃, 탭 구조 동일하게 적용
