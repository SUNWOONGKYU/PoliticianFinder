...
게시글 상세 페이지 (정치인) 작업을 완료하여 프로젝트의 Frontend 영역 개발을 진행합니다.
...
**기준 파일**: `0-2_UIUX_Design/prototypes/html/pages/post-detail_politician.html`
...
1. HTML 프로토타입 post-detail_politician.html을 Next.js로 변환
2. 정치인 작성 게시글 전용 레이아웃
3. 인증 배지 표시
4. 공식 답변 하이라이팅
