...
게시글 상세 페이지 (회원) 작업을 완료하여 프로젝트의 Frontend 영역 개발을 진행합니다.
...
**기준 파일**: `0-2_UIUX_Design/prototypes/html/pages/post-detail_member.html`
...
1. HTML 프로토타입 post-detail_member.html을 Next.js로 변환
2. 게시글 본문
3. 댓글 시스템
4. 좋아요/공유 버튼
5. 신고 기능
