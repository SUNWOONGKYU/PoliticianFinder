...
계좌이체 페이지 작업을 완료하여 프로젝트의 Frontend 영역 개발을 진행합니다.
...
**기준 파일**: `0-2_UIUX_Design/prototypes/html/pages/account-transfer.html`
...
1. HTML 프로토타입 account-transfer.html을 Next.js로 변환
2. 수취인 선택 (정치인)
3. 금액 입력
4. 결제 수단 선택
