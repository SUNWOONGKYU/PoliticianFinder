            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center md:text-left text-white">
                ...
                <button
                  ...
                  className="px-8 py-3 bg-white text-primary-600 rounded-xl font-bold hover:shadow-2xl hover:scale-105 transition-all flex items-center gap-2 mx-auto md:mx-0"
                >
