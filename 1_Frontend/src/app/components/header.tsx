        ...
        {mobileMenuOpen && (
          <div className="md:hidden pb-4">
            <div className="flex flex-col space-y-2">
              <Link href="/" className="text-gray-900 dark:text-gray-100 hover:text-primary-600 dark:hover:text-primary-400 font-medium px-2 py-2" onClick={() => setMobileMenuOpen(false)}>홈</Link>
              <Link href="/politicians" className="text-gray-900 dark:text-gray-100 hover:text-primary-600 dark:hover:text-primary-400 font-medium px-2 py-2" onClick={() => setMobileMenuOpen(false)}>정치인</Link>
              <Link href="/community" className="text-gray-900 dark:text-gray-100 hover:text-primary-600 dark:hover:text-primary-400 font-medium px-2 py-2" onClick={() => setMobileMenuOpen(false)}>커뮤니티</Link>
              <Link href="/connection" className="text-gray-900 dark:text-gray-100 hover:text-primary-600 dark:hover:text-primary-400 font-medium px-2 py-2" onClick={() => setMobileMenuOpen(false)}>연결</Link>
              <hr className="my-2 border-gray-200 dark:border-slate-700" />
              {!isMounted ? (
                <div className="text-gray-400 px-2 py-2"></div>
              ) : user ? (
                <>
                  <Link href="/mypage" className="text-gray-900 dark:text-gray-100 hover:text-primary-600 dark:hover:text-primary-400 font-medium px-2 py-2" onClick={() => setMobileMenuOpen(false)}>
                    {user.user_metadata?.name || user.email?.split('@')[0] || '마이페이지'}
                  </Link>
                  <button
                    onClick={() => {
                    ...
                    className="text-left text-gray-900 dark:text-gray-100 hover:text-red-600 dark:hover:text-red-400 font-medium px-2 py-2"
                  >
                    로그아웃
                  </button>
                </>
                ...
                <>
                  <Link href="/auth/login" className="text-gray-900 dark:text-gray-100 hover:text-primary-600 dark:hover:text-primary-400 font-medium px-2 py-2" onClick={() => setMobileMenuOpen(false)}>로그인</Link>
