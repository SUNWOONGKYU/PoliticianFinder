...
- ✅ **파일 없음** → work_log 확인하여 이어서 작업
  ```
  "inbox에 새 작업이 없습니다.
  이전 작업을 이어서 진행하겠습니다."
  ```

**🚨 중요: 사용자가 아무 말 안 해도 세션 시작하자마자 자동 확인!**

### 📬 평소 Inbox 자동 확인 규칙

**작업 중에도 주기적으로 inbox 확인:**

**확인 시점 (자동):**
1. ✅ **세션 시작 시** (필수)
2. ✅ **작업 완료 시** (다음 작업 확인)
3. ✅ **Phase 완료 시** (새 Phase 작업 확인)
4. ✅ **검증 완료 시** (다음 할 일 확인)
5. ✅ **유휴 상태일 때** (할 일 없을 때)
...
work_log에 기록
    ↓
inbox 자동 확인 (ls Web_ClaudeCode_Bridge/inbox/*.json)
    ↓
새 작업 발견!
    ↓
"작업 A를 완료하고 검증했습니다.

📬 inbox에서 새로운 작업을 발견했습니다:
- 파일: P1BA2.json
- 작업: 로그인 API 구현
...
**AI가 스스로 확인하는 시나리오:**
- ❌ 사용자: "inbox 확인해줘" → AI 확인 (느림, 수동)
- ✅ AI: 작업 완료 → 자동 inbox 확인 → "새 작업 발견!" (빠름, 자동)

**원칙:**
> **사용자가 요청하기 전에 AI가 먼저 확인!**
> **"할 일 없나요?" 묻지 말고 스스로 찾기!**
...
2. **`Web_ClaudeCode_Bridge/inbox/`** 🔴 **최우선!**
   - 대기 중인 새 작업 지시사항
...
5. **필수 검증**: 작업 완료 후 검증 도구 실행 자발적 제안 + **검증 후 inbox 자동 확인** (재작업 방지, 다음 작업 자동 발견)
