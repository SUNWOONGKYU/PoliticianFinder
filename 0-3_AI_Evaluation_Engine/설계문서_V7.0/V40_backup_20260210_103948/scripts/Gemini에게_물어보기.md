...
> **⚠️ 역사적 기록**: 이 문서는 V30→V40 전환 과정에서 Gemini API의 dummy URL 문제를
> 진단하기 위해 작성되었습니다. V40 최종 결정으로 **Gemini는 API 대신 CLI 방식**을
> 사용하게 되어, 이 문서의 API 관련 내용은 더 이상 적용되지 않습니다.
> 현재 가이드: `instructions/2_collect/GEMINI_CLI_수집_가이드.md`

**날짜**: 2026-01-28
**문제**: dummy URL과 redirect URL 대량 발생 (58.7%) → **CLI 방식으로 해결**
**버전**: V40
