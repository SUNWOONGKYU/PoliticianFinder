# V40 Gemini 해결 방법 (AI 답변)

> **⚠️ 역사적 기록**: 이 문서는 Gemini API의 dummy URL 문제에 대한 AI 답변을
> 기록한 것입니다. V40 최종 결정으로 **Gemini는 API 대신 CLI 방식**을 사용하게 되어,
> 아래 API 기반 해결 방법은 적용되지 않습니다.
> 현재 가이드: `instructions/2_collect/GEMINI_CLI_수집_가이드.md`
