...
# ============================================================
# Perplexity 테스트 (2단계: Search → Chat)
# ============================================================

def test_perplexity():
    """Perplexity 2단계 방식 테스트"""
    print("\n" + "="*60)
    print("🔶 Perplexity 테스트 (Search API → Chat API)")
    print("="*60)
    ...
    print("⚠️ Perplexity Search API는 별도 SDK 필요")
...
def main():
    print("\n" + "🔬"*30)
    print("Gemini + Perplexity 통합 테스트")
    print("🔬"*30)
    ...
    if gemini_result and perplexity_result:
        if gemini_result['success_rate'] >= 80 and perplexity_result['success_rate'] >= 80:
            ...
            print("✅ Perplexity만 80% 이상 달성")
            print("   → Perplexity 방식 우선 적용")
        else:
