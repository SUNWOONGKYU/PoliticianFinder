...
### 4.3 Perplexity 금지 도메인 필터링

**목적**: 뉴스/언론만 수집 (비언론 → Gemini 담당)

**금지 도메인**:
- youtube.com, wikipedia.org, namu.wiki
- blog.naver.com, tistory.com, brunch.co.kr
- dcinside.com, clien.net
- assembly.go.kr, korea.kr (→ Gemini OFFICIAL)
...
- 최소 30자 이상
- 수집 스크립트(collect_v30.py)에서 자동 생성
