...
# 배분: 10개 (버퍼 20% 포함 12개)
# 센티멘트: negative 2개 / positive 2개 / free 6개
# 이 파일은 collect_gemini_v50.py 또는 n8n 오케스트레이션이 로드합니다.
#
# [플레이스홀더 목록]
...
# - Google Search Grounding 활용 (Gemini 2.0 Flash-Lite REST API 방식)
...
- **free 6개**: 센티멘트 제한 없이 자유롭게 수집 (중립적 보도, 사실 전달 등)
...
## 최종 확인 사항
- [ ] {remaining}개 수집 (negative 2개 + positive 2개 + free 6개)
