...
사용법:
    ...
    # 2. 평가 결과 저장
    python claude_eval_helper.py save --politician_id=d0a5d6e1 --politician_name=조은희 --category=expertise --input=eval_result.json
...
def fetch_unevaluated(politician_id, politician_name, category):
    ...
    # 7. 배치 분할 정보
    batch_size = 50  # 10 → 50으로 증가 (평가 속도 5배 향상)
