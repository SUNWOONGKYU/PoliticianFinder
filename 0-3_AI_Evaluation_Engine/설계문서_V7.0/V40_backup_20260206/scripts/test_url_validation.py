...
test_urls = [
    ...
    ("https://ko.wikipedia.org/wiki/%EC%A1%B0%EC%9D%80%ED%9D%AC_(%EC%A0%95%EC%B9%98%EC%9D%B8)", "Perplexity 실패"),
    # 성공한 URL
    ("https://www.hankookilbo.com/News/Read/A2022030918440002122", "Gemini 성공"),
    ("https://namu.wiki/w/%EC%A1%B0%EC%9D%80%ED%9D%AC", "Perplexity 성공"),
]
