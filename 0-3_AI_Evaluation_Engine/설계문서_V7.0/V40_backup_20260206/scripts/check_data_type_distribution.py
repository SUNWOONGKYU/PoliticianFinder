...
# V40 목표와 비교 (Gemini 60% official + Naver 20% official = 40% total official)
# Gemini: 500개 (OFFICIAL 300 + PUBLIC 200)
# Naver: 500개 (OFFICIAL 100 + PUBLIC 400)
# Total: 1000개 (OFFICIAL 400 + PUBLIC 600)
expected_official = 400  # 40%
expected_public = 600    # 60%
