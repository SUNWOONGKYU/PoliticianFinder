# -*- coding: utf-8 -*-
"""
V40 문서 일괄 업데이트: Gemini+Naver 분담 구조 변경
- 수집: Gemini 50개 (OFFICIAL 30 + PUBLIC 20) + Naver 50개 (OFFICIAL 10 + PUBLIC 40)
...
def update_collect_files(filepath):
    ...
    if "Gemini (75%)" in content or "Naver (25%)" in content:
...
def update_readme(filepath):
    ...
    content = content.replace(
        '- **Grok (5%)**: 공개 5개',
        '- **Naver (25%)**: PUBLIC 25개 (수집만, 평가 안 함)'
    )
...
def main():
    ...
    print("="*60)
    print("V40 문서 일괄 업데이트: Gemini+Naver 구조 (50:50)")
    print("="*60)
    ...
    if success_count == total_count:
        ...
        print("\n변경 내용:")
        print("  - 수집: Gemini 95% + Grok 5% → Gemini 75% + Naver 25%")
