...
def recollect_official(politician_id, politician_name, target_per_category=50):
    ...
    print(f"\n{'#'*60}")
    print(f"# V40 Official 데이터 추가 수집")
    ...
    # AI별 배분 (V40 기준: Gemini 60%, Perplexity 30%, Grok 10%)
    ai_distribution = {
        'Gemini': 0.6,
        'Perplexity': 0.3,
        'Grok': 0.1
...
def main():
    parser = argparse.ArgumentParser(description='V40 Official 데이터 추가 수집')
