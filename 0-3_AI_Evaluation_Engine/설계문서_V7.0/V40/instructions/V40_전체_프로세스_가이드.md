...
│                                                             │
│ ⚠️ 최소 목표 50개로 수집 시 → Phase 2-2 재수집 필요!       │
│ ✅ 버퍼 목표 60개로 수집 시 → Phase 2-2 스킵 가능! (2-3시간 절약) │
│                                                             │
│ ⚠️ Claude/ChatGPT/Grok = 수집 제외 (평가만)               │
│                     ↓                                       │
│            collected_data_v40 저장                          │
├─────────────────────────────────────────────────────────────┤
│ [Phase 2] 검증 & 재수집 - validate_v40_fixed.py             │
│                                                             │
│ 실행 명령어:                                                 │
...
├─────────────────────────────────────────────────────────────┤
│ [Phase 3] 평가 - evaluate_v40.py (4개 AI)                   │
│                                                             │
