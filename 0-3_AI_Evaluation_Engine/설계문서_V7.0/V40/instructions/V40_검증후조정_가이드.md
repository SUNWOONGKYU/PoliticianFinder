...
### 12.1 핵심 교훈: Phase 2-2를 아예 방지하라!

**⭐ 가장 중요한 교훈:**
> **처음부터 버퍼 목표(60개/AI/카테고리)로 수집하면 Phase 2-2가 거의 필요 없습니다!**
...
→ Phase 2-2: 8라운드 재수집 (총 2시간 35분 소요)
→ 결과: 18 → 51개 (33개 추가 수집)

✅ 올바른 접근 (권장):
Phase 2: 버퍼 목표(60개)로 수집
→ Phase 3: 검증 후 대부분 50-60개 유지
→ Phase 2-2: 1-2라운드만 필요 또는 스킵 (15분 이내)
→ 시간 절약: 2시간 20분
```

### 12.2 시간 소요 분석

**조은희 Phase 2-2 실제 소요 시간:**
...
**❌ DON'T (하지 말 것):**
1. **최소 목표(50개)만 수집**: Phase 2-2 재수집 2-3시간 소요
...
- **adjust_v40_data.py**: 조정 스크립트 (Phase 2-2, 본 가이드 대상)
