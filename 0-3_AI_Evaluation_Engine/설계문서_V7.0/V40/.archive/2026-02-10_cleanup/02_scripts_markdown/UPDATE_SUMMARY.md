...
**Created**: Naver Search API 가이드
**Content**:
- Naver Search API 사용법
- News Search API 가이드
- OFFICIAL vs PUBLIC 구분
- 날짜 필터링 (OFFICIAL 4년, PUBLIC 2년)
...
| **Distribution** | Gemini 50 + Naver 50 |
...
### V40
```bash
# ⚠️ Gemini는 CLI 사용 (API 키 불필요)
NAVER_CLIENT_ID=...
NAVER_CLIENT_SECRET=...
OPENAI_API_KEY=...     # ChatGPT (평가용)
XAI_API_KEY=...        # Grok (평가용)
```
...
| Validate | validate_v30.py | validate_v40_fixed.py |
...
- ✅ Naver에게_물어보기.md (Naver Search API 가이드)
