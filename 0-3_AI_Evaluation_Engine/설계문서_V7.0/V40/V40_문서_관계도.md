...
**생성일**: 2026-02-10
**최종 수정**: 2026-02-21 (실제 코드 구조와 정밀 동기화)
...
graph TD
    ...
    class README hub
    class BASIC,PROCESS,ORCH,ADJUST_GUIDE,ARCH,TERM,GEMINI_GUIDE,NAVER_GUIDE,EVAL_UNIFIED,REPORT_GUIDE,POL_TEMP,POL_DONE,POL_WAIT doc
