...
graph TD
    ...
    %% 10계층: 자동화 워크플로우
    README --> NAVER_COLLECT[⚙️ workflow/collect_naver_v40_final.py<br/>Naver 수집]
    README --> GEM_COLLECT[⚙️ workflow/collect_gemini_subprocess_parallel.py<br/>Gemini 수집]
    NAVER_COLLECT --> VALIDATE
    GEM_COLLECT --> VALIDATE
...
| helpers/ | grok_eval_helper.py | Grok 3 평가 (xAI Agent Tools API) |
