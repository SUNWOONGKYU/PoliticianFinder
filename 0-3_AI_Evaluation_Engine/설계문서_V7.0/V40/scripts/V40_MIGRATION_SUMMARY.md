...
13. `test_both_solutions.py`
14. `test_redirect_url.py`
15. `test_url_validation.py`
...
- Gemini 50개 (OFFICIAL 30 + PUBLIC 20) + Naver 50개 (OFFICIAL 10 + PUBLIC 40)
- 100 items per category (50 from Gemini + 50 from Naver)

**OFFICIAL/PUBLIC breakdown:**
...
**1. evaluate_claude_auto.py**
- Generates evaluation tasks for Claude Code CLI Direct mode
...
**4. claude_eval_helper.py**
- Interactive evaluation mode for CLI Direct usage
...
**13. claude_eval_helper.py** (formerly claude_subscription_fix.py)
- Claude CLI Direct mode helper
...
- [x] 수집 채널: Gemini + Naver (50:50)
- [x] Distribution model updated (50-50)
...
### Evaluate with Claude (CLI Direct Mode)
