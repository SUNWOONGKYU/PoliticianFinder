INSERT INTO politicians (name, party, position, region, birth_date, is_verified, view_count, favorite_count, evaluation_score, evaluation_grade)
VALUES
  ...
  ('최서영', '민주당', '시장', '인천', '1969-05-30', TRUE, 2100, 487, 88, 'A+'),
  ('정태우', '국민의힘', '도지사', '경기', '1965-09-12', TRUE, 1890, 423, 80, 'B+'),
  ...
  ('오현준', '무소속', '시장', '대구', '1968-04-07', TRUE, 1670, 356, 81, 'A-'),
